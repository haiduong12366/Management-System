...
import { fetchIssueById, fetchIssues, updateIssueStatus } from "@/Redux/Issue/Action";
import { fetchComments } from "@/Redux/Comment/Action";

const IssueDetails = ({ issueId,projectId }) => {
    const dispatch = useDispatch()
    const {issue,comment} = useSelector(store=>store)


    const handleUpdateIssueStatus = async (status) => {
        await dispatch(updateIssueStatus({status,id:issueId}))
