                        ...
                        <div className="flex justify-between">
                            ...
                            {project.projectDetails?.owner.id ==auth.user.id &&
                                <Dialog>
                                        <DialogTrigger>
                                            <DialogClose>
                                                <Button size="sm" variant="outline" className="ml-2 bg-white">
                        ...
                        <div className="space-y-5 pb-10 text-sm">
                            ...
                            <section>
                                ...
                                <div className="lg:flex md:flex gap-3 justify-between py-5">
                                    <IssueList status={"pending"} title={"Todo list"} projectId={id} issue={issue}/>
                                    <IssueList status={"in_progress"} title={"In progress"} projectId={id} issue={issue}/>
                                    <IssueList status={"done"} title={"Done"} projectId={id} issue={issue}/>
                                </div>
                            </section>
                        </div>
                    </ScrollArea>
